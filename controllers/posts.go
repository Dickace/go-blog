...
func AddTelemetry(c *gin.Context){
	...
	telemtry := models.Telemetry{Interface: input.Interface, ICCID: input.ICCID, Tamb_degC: input.Tamb_degC, AX: input.AX ,AY: input.AY, AZ: input.AZ,  RSSI_dBm: input.RSSI_dBm, Latitude: input.Latitude, Longitude: input.Longitude, GNSS_data_valid: input.GNSS_data_valid }
